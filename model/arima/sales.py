...
from model.arima.arimaModel import *
...
def predictSales(data,n=6,isVisiable=False):
    '''
    程序执行的入口
    :param fname:输入文件
    :param n:预测的点个数
...
if __name__ == '__main__':
    # isVisiable可视化按钮
    data=pd.read_excel("sales.xls",index_col='日期',header=0)
    result = predictSales(data,4,isVisiable=True)